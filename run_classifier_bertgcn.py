...
def main():
    ...
    bert_params = list(filter(lambda kv: kv[0] in layer_list, model.named_parameters()))
    base_params = list(filter(lambda kv: kv[0] not in layer_list, model.named_parameters()))
